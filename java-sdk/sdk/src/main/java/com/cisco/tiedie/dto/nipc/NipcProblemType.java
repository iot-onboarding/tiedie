...
public enum NipcProblemType {
    ...
    UNSUPPORTED_URI_SCHEME("https://www.iana.org/assignments/nipc-problem-types#unsupported-uri-scheme"),
    PROPERTY_NOT_READABLE("https://www.iana.org/assignments/nipc-problem-types#property-not-readable"),
    PROPERTY_READ_FAILED("https://www.iana.org/assignments/nipc-problem-types#property-read-failed"),
    PROPERTY_NOT_WRITABLE("https://www.iana.org/assignments/nipc-problem-types#property-not-writable"),
    PROPERTY_WRITE_FAILED("https://www.iana.org/assignments/nipc-problem-types#property-write-failed"),
    ...
    EXTENSION_TRANSMIT_INVALID_DATA("https://www.iana.org/assignments/nipc-problem-types#extension-transmit-invalid-data"),
